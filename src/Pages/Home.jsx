          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-6">
            {skills.map((skill, index) => (
              <Card key={index} className="text-center p-6 group">
                <FontAwesomeIcon 
                  icon={skill.icon} 
                  className="text-5xl text-lime-600/60 dark:text-lime-400/50 group-hover:text-lime-600 dark:group-hover:text-lime-400 transition-colors duration-300 mb-4"
                />
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="p-8">
                <div className="mb-4">
                  <svg className="w-12 h-12 text-lime-600/40 dark:text-lime-400/30 mb-4" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  <p className="text-lime-700 dark:text-lime-400 font-semibold">{testimonial.author}</p>
